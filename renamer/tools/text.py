...
class TEXT:
    ...
    UPLOAD_SUCESS = f"Thanks for using [me](https://github.com/selfie-bd/TG-RENAMER-BOT)"
    BANNED_USER_TEXT = f"Hey Buddy! You are **banned** from using me {FACE_WITH_TEARS_OF_JOY}."
...
** Channel:** [DC BOT UPDATES](https://t.me/umlinks)

** Group:** [Dc BOT SUPPORT](https://t.me/groupdc)

** Source Code:** [Press Me](https://github.com/selfie-bd/TG-RENAMER-BOT)
"""
